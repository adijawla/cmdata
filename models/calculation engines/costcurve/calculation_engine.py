...
class costcurve():
    ...
    def __init__(self):
        self.inputdata = pd.read_csv("cc_inputtable.csv",encoding = "ISO-8859-1")
    ...
    def inputdata_rankcost(self,indx):
        ...
        self.inputdata.loc[indx,"Rank Cost Proxy"] = value
    ...
    def table1datacalc2(self,indx):
        ...
        self.table1data.loc[indx,'Cumulative Prodn / Capacity'] = value
    ...
    def table3start(self):
        ...
        self.table3data.loc[0,'x'] = value1
        self.table3data.loc[0,'line 1'] = value2
        self.table3data.loc[0,'line 2'] = value3
        self.table3data.loc[0,'line 3'] = value4
        self.table3data.loc[0,'line 4'] = value5
        self.table3data.loc[0,'line 5'] = value6
        self.table3data.loc[0,'line 6'] = value7
        self.table3data.loc[0,'line 7'] = value8
        self.table3data.loc[0,'line 8'] = value9
        self.table3data.loc[0,'line 9'] = value10
        self.table3data.loc[0,'line 10'] = value11

    def table3intialisation(self,indx):
        value1 = "bar "+str(((indx+4)//5))+" start"
        value2 = "bar "+str(((indx+4)//5))+" an"
        value3 = "bar "+str(((indx+4)//5))+" naming"
        value4 = "bar "+str(((indx+4)//5))+" bn"
        value5 = "bar "+str(((indx+4)//5))+" end"
        self.table3data.loc[indx,'initialisation'] = value1
        self.table3data.loc[indx+1,'initialisation'] = value2
        self.table3data.loc[indx+2,'initialisation'] = value3
        self.table3data.loc[indx+3,'initialisation'] = value4
        self.table3data.loc[indx+4,'initialisation'] = value5

    def table3bar(self,indx):
        value = str(((indx+4)//5))
        self.table3data.loc[indx,'bar'] = value
        self.table3data.loc[indx+1,'bar'] = value
        self.table3data.loc[indx+2,'bar'] = value
        self.table3data.loc[indx+3,'bar'] = value
        self.table3data.loc[indx+4,'bar'] = value
...
# formulas from here
    ...
    def table3capprod(self,indx):
        ...
        self.table3data.loc[indx,'x'] = value1
        self.table3data.loc[indx+1,'x'] = value2
        self.table3data.loc[indx+2,'x'] = value3
        self.table3data.loc[indx+3,'x'] = value4
        self.table3data.loc[indx+4,'x'] = value5
    ...
    def table3line(self,indx,i):
        ...
        value4 = value3
        value5 = value1
        self.table3data.loc[indx,'line '+str(i)] = value1
        self.table3data.loc[indx+1,'line '+str(i)] = value2
        self.table3data.loc[indx+2,'line '+str(i)] = value3
        self.table3data.loc[indx+3,'line '+str(i)] = value4
        self.table3data.loc[indx+4,'line '+str(i)] = value5
    ...
    def table4calc(self):
        ...
        self.table4data.loc[0,'Q1 x'] = value1
        self.table4data.loc[0,'Q1'] = value2
        self.table4data.loc[0,'Q2 x'] = value3
        self.table4data.loc[0,'Q2'] = value4
        self.table4data.loc[0,'Q3 x'] = value5
        self.table4data.loc[0,'Q3'] = value6
        self.table4data.loc[1,'Q1 x'] = value7
        self.table4data.loc[1,'Q1'] = value8
        self.table4data.loc[1,'Q2 x'] = value9
        self.table4data.loc[1,'Q2'] = value10
        self.table4data.loc[1,'Q3 x'] = value11
        self.table4data.loc[1,'Q3'] = value12
    ...
    def table5start(self):
        ...
        value10 = 0
        value11 = 0
        self.table5data.loc[0,'x'] = value1
        self.table5data.loc[0,'area 1'] = value1
        self.table5data.loc[0,'area 2'] = value1
        self.table5data.loc[0,'area 3'] = value1
        self.table5data.loc[0,'area 4'] = value1
        self.table5data.loc[0,'area 5'] = value1
        self.table5data.loc[0,'area 6'] = value1
        self.table5data.loc[0,'area 7'] = value1
        self.table5data.loc[0,'area 8'] = value1
        self.table5data.loc[0,'area 9'] = value1
        self.table5data.loc[0,'area 10'] = value1
    ...
    def table5capprod(self,indx):
        ...
        value5 = value4
        self.table5data.loc[indx,'x'] = value1
        self.table5data.loc[indx+1,'x'] = value2
        self.table5data.loc[indx+2,'x'] = value3
        self.table5data.loc[indx+3,'x'] = value4
        self.table5data.loc[indx+4,'x'] = value5
    ...
    def table5area(self,indx):
        for i in range(1,11):
            ...
            value4 = value3
            value5 = value1
            self.table5data.loc[indx,'area '+str(i)] = value1
            self.table5data.loc[indx+1,'area '+str(i)] = value2
            self.table5data.loc[indx+2,'area '+str(i)] = value3
            self.table5data.loc[indx+3,'area '+str(i)] = value4
            self.table5data.loc[indx+4,'area '+str(i)] = value5
...
dblist = [
    db_conv.single_year_mult_out(r.table1data, "sorted_input_data"),
