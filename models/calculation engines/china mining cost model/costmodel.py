...
#[dbo].[rsdatabasemine]
#renaming
rs_renames = {'province':'Province','county':'County','mine':'Mine','mine_status':'Status','tonnesproduced':'TonnesProduced','gradeal2o3':'GradeAl2O3','asa':'AS','miningscale':'MiningScale','dressingautolevel':'Dressingautolevel','minetypeopenpit':'MineTypeOpenPit','minetypeunderground':'MineTypeUnderground','depthopenpit':'DepthOpenPit',
              'depthunderground':'DepthUnderground','strippingratioopenpit':'StrippingRatioOpenPit','strippingratiounderground':'StrippingRatioUnderground','distanceopenpit':'DistanceOpenPit','distanceunderground':'DistanceUnderground','localtaxandfees':'LocalTaxandfees','distance':'Distance','dressingratio':'DressingRatio','mineautolevel':'Mineautolevel'}
...
tx_renames = {'to_refinery':'To refinery','in_mine':'In Mine','royalty':'Royalty','other':'Other'}
lp_renames = {}
######
...
dblist.append(db_conv.single_year_mult_out(dbi.db,'china_mining_cost'))
dblist.append(db_conv.single_year_mult_out(b,'china_mining_cost_summary'))
...
with pd.option_context('display.max_rows', None, 'display.max_columns', None):
    ...
    dbi.db.to_csv("outputdata/costmodeloutput.csv",index=False)
    b.to_csv("outputdata/sumout.csv",index=False)
