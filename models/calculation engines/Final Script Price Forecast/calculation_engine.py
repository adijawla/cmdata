...
class PriceForecastModel:
    def __init__(self):
        ...
        self.BARactual=pd.read_excel ('Inputs/EM_BAR for actual supply.xlsx',sheet_name='EM_BAR for actual supply')
    ...
    def CostofSupplyOnlythoseSupplying(self):
        ...
        dblist.append(pf_flat.mult_year_single_output(E11, "1165 and Who ia at margin R10"))
    ...
    def AfricaChalco(self):
        ...
        dblist.append(pf_flat.mult_year_single_output(FinalDataframe, "Africa-Chalco Boffa-Guine J 278.csv"))
        FinalDataframe.to_csv("Africa-Chalco Boffa-Guine J 278.csv",encoding='utf-8',index=False) 
        ...
        for i in range(1,E11.shape[1]):
            for j in range(E11.shape[0]):
                if D19.iloc[j,i]>0:
                    ...
                    W255.iloc[j,i]=str(E11.iloc[j,i])+',[$/dmt '+str(D12.iloc[j,i])+',['+str(D19.iloc[j,i])+' mln dmt]'
    ...
    def EngineMain1815and1160(self): 
        ...
        dblist.append(pf_flat.mult_year_single_output(EM1815, "Engine Main1815 and 1160"))
