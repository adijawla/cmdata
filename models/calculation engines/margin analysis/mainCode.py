...
all_rev = interrelationship_rest(np)
...
class marginAnalysis:
    def __init__(self):
        ...
        self.fullCostCFR        = all_rev["Collector Full Cost Cfr (Us$-Dmt)"]
