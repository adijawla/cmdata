...
class DB_TO_FILE:
    ...
    def splittingfactor(self):
        ...
        #Save all files
        # self.df3.to_excel(r"models\calculation engines\row mining\db_inputs\mine.xlsx",sheet_name='Sheet1',encoding='utf-8')
        # join13.to_excel(r"models\calculation engines\row mining\db_inputs\Paramax1.xlsx",sheet_name='Sheet1',encoding='utf-8')
        # join3.to_excel(r"models\calculation engines\row mining\db_inputs\capefright1.xlsx",sheet_name='Sheet1',encoding='utf-8',index=False)
        # join9.to_excel(r"models\calculation engines\row mining\db_inputs\MineInfo1.xlsx",sheet_name='Sheet1')        
        # join6.to_excel(r"models\calculation engines\row mining\db_inputs\cost_spec_input1.xlsx",sheet_name='Sheet1',encoding='utf-8')        
        # join7.to_excel(r"models\calculation engines\row mining\db_inputs\diesel_index1.xlsx",sheet_name='Sheet1',encoding='utf-8',index=False)        
        # join8.to_excel(r"models\calculation engines\row mining\db_inputs\fxrates1.xlsx",sheet_name='Sheet1',encoding='utf-8')
        # join15.to_excel(r"models\calculation engines\row mining\db_inputs\fxratestomines1.xlsx",sheet_name='Sheet1',encoding='utf-8')
        # join16.to_excel(r"models\calculation engines\row mining\db_inputs\splittingfactor1.xlsx",sheet_name='Sheet1',encoding='utf-8')        
        # join18.to_excel(r"models\calculation engines\row mining\db_inputs\costspec2.xlsx",sheet_name='Sheet1',encoding='utf-8')
