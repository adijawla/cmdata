...
class WorldTradeModel():
    ...
    def RT(self):
        ...
        join5.to_csv("BigMatrix RST.csv", index=False)
    ...
    def WtoAK(self):
        ...
        DF1.to_csv("BigMatrix WtoAK.csv", index=False)
        return DF1,df4
    ...
    def ARtoAT(self):
        ...
        Value.to_csv("BigMatrix ARtoAT.csv", index=False)
    ...
    def AVtoAX(self):
        ...
        AVToAX.to_csv("BigMatrix AVtoAX.csv", index=False)
    ...
    def BBtoBP(self):
        ...
        for j in range(projects12.shape[0]):
            ...
            projects13.iloc[j,0]=projects12.iloc[j,4]+'_'+projects12.iloc[j,2]
            projects13.iloc[j,1]=projects12.iloc[j,2]+'_'+projects12.iloc[j,4]
            j=j+1
        ...
        for j in range(projects12.shape[0]):
            projects12.iloc[j,5]=projects12.iloc[j,5]/1000000  
            if projects12.iloc[j,3]=='KG':
                projects12.iloc[j,5]=projects12.iloc[j,5]/1000
            else:
        ...
        joinExporter.to_csv("BigMatrix BBtoBP.csv", index=False)
    ...
    # Dropping old Name columns 
        ...
        DF2.to_csv("BigMatrix BStoCH.csv", index=False)
        DF3=DF2.transpose()
        DF3=DF3.reset_index()
        new1 = DF3["index"].str.split("_", n = 1, expand = True)
        DF3["MONTH"]=new1[1]
    ...
    def COtoCQ(self):
        ...
        value.to_csv("BigMatrix COtoCQ.csv", index=False)
    ...
    def CStoCU(self):
        ...
        AVtoAX.to_csv("BigMatrix CStoCU.csv", index=False)
        return AVtoAX
    def CXtoDA(self):
        ...
        CX.to_csv("BigMatrix CXtoDA.csv", index=False)
    ...
    def DC(self):
        ...
        DC1.to_csv("BigMatrix DCtoDI.csv", index=False)
    ...
    def DKtoDS(self):
        ...
        DCV.to_csv("BigMatrix DKtoDS.csv", index=False)
    ...
    def DWtoEB(self):
        ...
        DK.to_csv("BigMatrix DWtoEB.csv", index=False)
    ...
    def FinalProcessing(self):
        ...
        DK.to_csv("Final processing DtoI.csv", index=False)
        ...
        DK1.to_csv("Final processing MtoR.csv", index=False)
        ...
        DK3.to_csv("Final processing VtoAA.csv", index=False)
        ...
        FT2.to_csv("Final Processing AEtoAG.csv", index=False)
        FT3.to_csv("Final Processing AItoAK.csv", index=False)
        LastQuarter2.to_csv("Final Processing Last Quarter.csv", index=False)
        LastYear2.to_csv("Final Processing Last Year.csv", index=False)
    ...
    def RowExportersModelRANK(self): 
        ...
        Rank.to_csv("ROWEXPORTER Rank1.csv", index=False)
    ...
    def RowExportersModelRANK2(self): 
        ...
        Rank1.to_csv("ROWEXPORTER Rank2.csv", index=False)
    ...
    def RowExporterOutput2(self)  :
        ...
        RankValues.to_csv("ROWEXPORTERTABLE2.csv", index=False)
    ...
    def RowExporterOutpu1(self)  :
        ...
        RankValues1.to_csv("ROWEXPORTERTABLE1.csv", index=False)
