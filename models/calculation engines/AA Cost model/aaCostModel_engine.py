...
#global imports
import_bx_tonnes_filename = 'inputs\Import Bx Tonnes & CFR.xlsx'
imported_bx_xtcs_filename = 'inputs\Imported Bx Characteristics.xlsx'
pdt_cost_current_filename ='inputs\PDT cost current.xlsx'
lookup_filename = 'inputs\Look up tables.xlsx'
refineriesPDT_filename = 'inputs\Refineries PDT Data.xlsx'
refCapProduction_filename = 'inputs\Refineries Capacity and Production.xlsx'
